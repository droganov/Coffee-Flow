...
(function() {
  var Coffeeflow, CoffeeflowItem, Preloader, compatible, defaults, isCompatible, j, log, prefix, settings;
  ...
  Coffeeflow = (function() {
    ...
    function Coffeeflow(el, options) {
      var arrange, canvas, changeTimeout, container, currentItem, getState, hammer, i, item, items, onChange, onMouseWheel, ready, sItem, self, setState, stack, state, ts, _i, _len,
        _this = this;
      container = j(el);
  ...
  CoffeeflowItem = (function() {
    ...
    function CoffeeflowItem(el, i, p) {
      var align, anchor, attach, attached, completeTimeout, crop, data, depth, detach, img, item, link, load, onComplete, preloader, render, select, self, size, source, state, visible, xPos;
      el = j(el);
      i = i;
      p = p;
      self = this;
      ...
      crop = function() {
        var iBottom, iHeight, iLeft, iScale, iWidth;
      ...
      render = function(x) {
        ...
        if (!attached) {
          ...
          img.error(function(e) {
            return preloader.setState("error");
          });
          if (typeof Hammer !== "undefined" && Hammer !== null) {
