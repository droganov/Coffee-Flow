...
(function() {
  ...
  CoffeeflowItem = (function() {
    ...
    function CoffeeflowItem(obj, i, p, settings) {
      var align, anchor, aspect, attach, attached, completeTimeout, crop, data, depth, img, item, link, load, onComplete, preloader, ready, render, self, setTransform, source, state, visible, xPos;
      i = i;
      p = p;
      self = this;
      try {
